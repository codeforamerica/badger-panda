...
if (!maintenance) {
    ...
    socket.on('connection', function(client) {
        // Tell the client about throttling.
        client.send({
            'isThrottled': settings.throttle
        });
    
        // This is not accurate.  The real IP is available in the
        // Express route below, but these are currently disconnected.
        ...
        client.on('message', function(message) {
            ...
            if (message.action) {
                ...
                if (message.action == 'save-vote') {
                    ...
                    // If not throttle or not throttling
